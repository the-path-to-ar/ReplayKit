...
namespace SA.iOS.ReplayKit.Internal
{
    ...
    [DllImport ("__Internal")] static extern void _ISN_SetMicrophoneEnabled(bool enabled);
        ...
        Action<string> m_stopRecordingExtendCallback = delegate { };
        ...
        public void StopRecordingExtend(Action<string> callback)
        {
            m_stopRecordingExtendCallback = callback;
#if ((UNITY_IPHONE || UNITY_TVOS) && REPLAY_KIT_API_ENABLED)
            _ISN_StopRecording();
#endif
        }
        ...
        void OnRecorStopResultExtend(string data)
        {

            m_stopRecordingExtendCallback.Invoke(data);
        }
